/**
 * @file NeoFileReader.h
 * @brief Header file for class NeoFileReader
 * @date 11/08/2017
 * @author Andre Neto
 *
 ...
 * @details This header file contains the declaration of the class NeoFileReader
 * with all of its public, protected and private members. It may also include
 * definitions for inline methods which need to be visible to the compiler.
 */

#ifndef FILEDATASOURCE_NeoFileReader_H_
#define FILEDATASOURCE_NeoFileReader_H_
 ...
 *     XAxisSignal = "Time" //Compulsory if Interpolate = "yes" and none of the signals interacting with this NeoFileReader has Frequency > 0. Name of the signal containing the independent variable to generate the interpolation samples.
 *     InterpolationPeriod = 1000 //Compulsory if Interpolate = "yes" and none of the signals interacting with this NeoFileReader has Frequency > 0. InterpolatedXAxisSignal += InterpolationPeriod. It will be read as an uint64.
 ...
 * </pre>
 */
class NeoFileReader: public DataSourceI, public MessageI {
...
private:
    ...
    /**
     * True if the data is being read from the file for the first time.
     */
    bool firsttime;
...
#endif /* FILEDATASOURCE_NeoFileReader_H_ */
