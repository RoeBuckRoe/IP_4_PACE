#ifndef SOURCE_COMPONENTS_GAMS_BGAM_BGAM_H_
#define SOURCE_COMPONENTS_GAMS_BGAM_BGAM_H_
 ...
 * </pre>
 */
class BGAM : public MARTe::GAM, public MARTe::StatefulI {
public:
...
#endif // SOURCE_COMPONENTS_GAMS_BGAM_BGAM_H_