#ifndef SOURCE_COMPONENTS_GAMS_BalanceLQRGAM_BalanceLQRGAM_H_
#define SOURCE_COMPONENTS_GAMS_BalanceLQRGAM_BalanceLQRGAM_H_
...
//TODO documentation
class BalanceLQRGAM : public MARTe::GAM, public MARTe::StatefulI {
public:
    CLASS_REGISTER_DECLARATION()

    BalanceLQRGAM();

    virtual ~BalanceLQRGAM();
...
#endif // SOURCE_COMPONENTS_GAMS_BalanceLQRGAM_BalanceLQRGAM_H_
